        ...
        <div className=' bg-[#F5F5F5] grid grid-cols-1 gap-y-3 rounded-[3rem] px-6 py-8 w-full mx-auto'>
            <div className='bg-white rounded-full px-3 h-14 flex justify-between items-center'>
                ...
                <div className='flex text-[#646464] items-center'>
                    ...
                    <div className='bg-[#FFF3CA] mr-4 text-goldbtn px-4 overflow-hidden w-40 text-center  font-medium py-1 rounded-full'>
                        {item.index}</div>
                </div>
            </div>
            ...
            <div className='xl:flex items-center pr-2 justify-between'>
                ...
                <div className='flex w-3/5 justify-end space-x-2'>
                    ...
                    <Link to={"/edit/"+item.id}><button className="bg-[#DBE8F6] font-medium p-3 rounded-full text-white">
                        <Edit />
                    </button>
                    </Link>
